...
import { FaPaperPlane, FaRobot, FaChartLine } from 'react-icons/fa'
  ...
  return (
    ...
    >
      <motion.header
        ...
        className={`p-4 ${isDark ? 'bg-gray-800' : 'bg-teal-600'} text-white flex items-center gap-3`}
      >
        <FaRobot className="h-6 w-6" />
        <h1 className="text-xl font-bold">AutiCare Assistant</h1>
      </motion.header>

      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full p-4 space-y-6">
        {/* Insights Section */}
        <motion.section
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto mb-4 p-4 rounded-lg bg-gray-100 dark:bg-gray-900">
            <AnimatePresence>
