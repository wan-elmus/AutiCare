...
export default function Navbar({ userData }) {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-40 shadow-lg ${isDark ? 'bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900' : 'bg-gradient-to-r from-teal-50 via-blue-50 to-teal-50'}`}>
